...
export const RAIBLOCKSMC_DONATION_ACCOUNT =
  "nano_1boirkfg4ga3m1t9g3z5ocrgozmzh8e1unqgz5y8c3zcgiy3hepss1uizxtr";
      ...
      <Row gutter={[12, 0]}>
        <Col xs={24} md={12}>
          ...
          {Object.keys(statistics).length !== 0 && (
            <Card size="small" bordered={false} className="detail-layout">
              <Title level={4}>
                {t("pages.raiblocksmc.statsDividers.server")}
              </Title>
              <Row gutter={6}>
                <Col xs={24} sm={6}>
              ...
              <Divider />
              <Title level={4}>
                {t("pages.raiblocksmc.statsDividers.treasure")}
                <Tooltip
                  placement="right"
                  title={
                    t("pages.raiblocksmc.tooltips.treasure") +
                    ` Ӿ ${statistics?.treasureHuntIncreaseRate}`
                  }
                >
                  <QuestionCircle />
                </Tooltip>
              ...
              <Divider />
              <Title level={4}>
                {t("pages.raiblocksmc.statsDividers.market")}
                <Tooltip
                  placement="right"
              ...
              <Divider />
              <Title level={4}>
                {t("pages.raiblocksmc.statsDividers.pvp")}
                <Tooltip
                  placement="right"
                  title={
                    t("pages.raiblocksmc.tooltips.pvp") +
                    ` Ӿ ${statistics?.pvpWorldJoinBet}`
                  }
                >
                  <QuestionCircle />
                </Tooltip>
              ...
              <Divider />
              <Title level={4}>
                {t("pages.raiblocksmc.statsDividers.referral")}
                <Tooltip
                  placement="right"
                  title={
                    t("pages.raiblocksmc.tooltips.referral") +
                    ` Ӿ ${statistics?.referralJoiningReward}`
                  }
                >
                  <QuestionCircle />
                </Tooltip>
        ...
        {Object.keys(statistics).length !== 0 && (
          <Col xs={24} md={12}>
            ...
            <Card size="small" bordered={false} className="detail-layout">
              ...
              >
                <Tabs.TabPane
                  tab={t("pages.raiblocksmc.leaderboardTabs.treasureHunt")}
                  key="1"
                >
                  <TreasureHuntLeaderboard
                    treasureHuntLeaderboard={leaderboards.treasureHunt}
                  />
                </Tabs.TabPane>
                <Tabs.TabPane
                  tab={t("pages.raiblocksmc.leaderboardTabs.market")}
                  key="2"
                >
                  <MarketLeaderboard marketLeaderboard={leaderboards.shops} />
                </Tabs.TabPane>
                <Tabs.TabPane
                  tab={t("pages.raiblocksmc.leaderboardTabs.pvp")}
                  key="3"
                >
                  <PvpLeaderboard pvpLeaderboard={leaderboards.pvp} />
                </Tabs.TabPane>
                <Tabs.TabPane
                  tab={t("pages.raiblocksmc.leaderboardTabs.referral")}
                  key="4"
                >
                  <ReferralLeaderboard
                    referralLeaderboard={leaderboards.referral}
                  />
                </Tabs.TabPane>
              </Tabs>
            </Card>
